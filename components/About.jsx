      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row">
          ...
          >
            ...
            <p>
              Hotely, the cutting-edge hotel search website, seamlessly combines
              intuitive design with advanced algorithms to offer users a
              personalized and hassle-free experience in discovering their ideal
